$(function () {
    $('#calc').click(function () {
        ...
        $('#result').load("/BasicServlet?var1=" + var1 + "&var2=" + var2 + "&operation=" + operation);
    });

    $('#hello_text').click(function () {
        $('#say_hello').load("/BasicServlet");
    });

    $(function () {
        $('#answer_random').load("/BasicServlet?var1=random");
    ...
    $('#closer-submit').click(function () {
        var m = $('#m').val();
        var n = $('#n').val();
        $('#closer-result').load("/BasicServlet?var1=closer&m=" + m + "&n=" + n);
    });
    ...
    $.get("/BasicServlet", {var1: "table"})
        .done(function (data) {
            console.log(data);
            drawTable("#random-table", data);
            
        });
    $.get("/BasicServlet", {var1: "tableMax"})
        .done(function (data) {
            console.log(data);
